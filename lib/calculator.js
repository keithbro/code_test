...
const getCompensation = (person, rule) => {
...
module.exports = {
  ...
  getCompensationForWeek: (person, date, rules) => {
    const week = getWeek(person.injuryDate, date)
    const rule = getRule(rules, week)
    return getCompensation(person, rule)
  },
